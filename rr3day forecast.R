...
final_input3.3 <- as.data.frame(cbind(target3, std_input3))
...
x3.3 <- model.matrix(target3 ~ . , data = input_train3)[,-1]

y <- input_train3$target3


cv_ridge_train3.3 <- cv.glmnet(
...
ridge_predict_train3.3 <- predict(cv_ridge_train3.3, x3.3)
...
ridge_predict_test3.3 <- predict(cv_ridge_train3.3, input_test3_ivs)

ridge_rmse3.3 <- RMSE(ridge_predict_test3.3, input_test3$target3)

ridge_rmse3.3

cv_lasso_train3.3 <- cv.glmnet(
...
lasso_predict_train3.3 <- predict(cv_lasso_train3.3, x3.3)
...
lasso_predict_test3.3 <- predict(cv_lasso_train3.3, input_test3_ivs)


lasso_rmse_test3.3 <- RMSE(lasso_predict_test3.3, input_test3$target3)
...
final_input3.5 <- as.data.frame(cbind(target3, std_input5))
...
x3.5 <- model.matrix(target3 ~ . , data = input_train5)[,-1]

y <- input_train5$target3




cv_ridge_train3.5 <- cv.glmnet(
...
ridge_predict_train3.5 <- predict(cv_ridge_train3.5, x3.5)
...
ridge_predict_test3.5 <- predict(cv_ridge_train3.5, input_test5_ivs)

ridge_rmse_test3.5 <- RMSE(ridge_predict_test3.5, input_test5$target3)

ridge_rmse_test3.5

cv_lasso_train3.5 <- cv.glmnet(
...
lasso_predict_train3.5 <- predict(cv_lasso_train3.5, x3.5)
...
lasso_predict_test3.5 <- predict(cv_lasso_train3.5, input_test5_ivs)


lasso_rmse_test3.5 <- RMSE(lasso_predict_test3.5, input_test5$target3)
...
final_input3.7 <- as.data.frame(cbind(target3, std_input7))
...
x3.7 <- model.matrix(target3 ~ . , data = input_train7)[,-1]

y <- input_train7$target3




cv_ridge_train3.7 <- cv.glmnet(
...
ridge_predict_train3.7 <- predict(cv_ridge_train3.7, x3.7)
...
ridge_predict_test3.7 <- predict(cv_ridge_train3.7, input_test7_ivs)

ridge_rmse_test3.7 <- RMSE(ridge_predict_test3.7, input_test7$target3)

ridge_rmse_test3.7

cv_lasso_train3.7 <- cv.glmnet(
...
lasso_predict_train3.7 <- predict(cv_lasso_train3.7, x3.7)
...
lasso_predict_test3.7 <- predict(cv_lasso_train3.7, input_test7_ivs)


lasso_rmse_test3.7 <- RMSE(lasso_predict_test3.7, input_test7$target3)
...
vip(cv_ridge_train3.3)
vip(cv_ridge_train3.5)
vip(cv_ridge_train3.7)

vip(cv_lasso_train3.3)
vip(cv_lasso_train3.5)
vip(cv_lasso_train3.7)
