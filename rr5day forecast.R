...
final_input5.3 <- as.data.frame(cbind(target5, std_input3))
...
x5.3 <- model.matrix(target5 ~ . , data = input_train3)[,-1]

y <- input_train3$target5


cv_ridge_train5.3 <- cv.glmnet(
...
ridge_predict_train5.3 <- predict(cv_ridge_train5.3, x5.3)
...
ridge_predict_test5.3 <- predict(cv_ridge_train5.3, input_test3_ivs)

ridge_rmse_test5.3 <- RMSE(ridge_predict_test5.3, input_test3$target5)
...
lasso_predict_train5.3 <- predict(cv_lasso_train5.3, x5.3)
...
lasso_predict_test5.3 <- predict(cv_lasso_train5.3, input_test3_ivs)


lasso_rmse_test5.3 <- RMSE(lasso_predict_test5.3, input_test3$target5)
...
final_input5.5 <- as.data.frame(cbind(target5, std_input5))
...
x5.5 <- model.matrix(target5 ~ . , data = input_train5)[,-1]

y <- input_train5$target5




cv_ridge_train5.5 <- cv.glmnet(
...
ridge_predict_train5.5 <- predict(cv_ridge_train5.5, x5.5)
...
ridge_predict_test5.5 <- predict(cv_ridge_train5.5, input_test5_ivs)

ridge_rmse_test5.5 <- RMSE(ridge_predict_test5.5, input_test5$target5)

ridge_rmse_test5.5



cv_lasso_train5.5 <- cv.glmnet(
...
lasso_predict_train5.5 <- predict(cv_lasso_train5.5, x5.5)
...
lasso_predict_test5.5 <- predict(cv_lasso_train5.5, input_test5_ivs)


lasso_rmse_test5.5 <- RMSE(lasso_predict_test5.5, input_test5$target5)
...
final_input5.7 <- as.data.frame(cbind(target5, std_input7))
...
x5.7 <- model.matrix(target5 ~ . , data = input_train7)[,-1]

y <- input_train7$target5




cv_ridge_train5.7 <- cv.glmnet(
...
ridge_predict_train5.7 <- predict(cv_ridge_train5.7, x5.7)
...
ridge_predict_test5.7 <- predict(cv_ridge_train5.7, input_test7_ivs)

ridge_rmse_test5.7 <- RMSE(ridge_predict_test5.7, input_test7$target5)

ridge_rmse_test5.7


cv_lasso_train5.7 <- cv.glmnet(
...
lasso_predict_train5.7 <- predict(cv_lasso_train5.7, x5.7)
...
lasso_predict_test5.7 <- predict(cv_lasso_train5.7, input_test7_ivs)


lasso_rmse_test5.7 <- RMSE(lasso_predict_test5.7, input_test7$target5)
...
vip(cv_ridge_train5.3)
vip(cv_ridge_train5.5)
vip(cv_ridge_train5.7)

vip(cv_lasso_train5.3)
vip(cv_lasso_train5.5)
vip(cv_lasso_train5.7)
